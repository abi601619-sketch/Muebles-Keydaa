    ...
    public partial class frmPedidosSecretario : Form
    {
        ...
        private void ConfigurarTablas()
        {
            ...
            if (dgvPedidosRegistrados.Columns.Contains("IdPedido"))
            {
                ...
                dgvPedidosRegistrados.Columns["IdPedido"].HeaderText =
                    "N.º de Pedido";
            ...
            {
                dgvDetallesDePedido.Columns["Mueble"].HeaderText =
                    "Mueble";
            ...
            {
                dgvDetallesDePedido.Columns["Cantidad"].HeaderText =
                    "Cantidad";
            ...
            {
                dgvDetallesDePedido.Columns["Medidas"].HeaderText =
                    "Medidas";
        ...
        private void ConfigurarTooltips()
        {
            ...
            toolTip.SetToolTip(
                dtpFechaPedido,
                "Seleccione la fecha en que se realizó el pedido."
            );

            toolTip.SetToolTip(
                dtpFechaEntrega,
                "Seleccione la fecha en que se entregará el pedido."
            );

            toolTip.SetToolTip(
                cbEstado,
                "Seleccione el estado actual del pedido."
            );

            toolTip.SetToolTip(
                txtClienteSeleccionado,
                "Cliente seleccionado para el pedido."
            );

            // Detalles del producto
            toolTip.SetToolTip(
                txtMuebleaRealizar,
                "Mueble que desea agregar al pedido o modificar del pedido."
            );

            toolTip.SetToolTip(
                nudCantidad,
                "Indique la cantidad de muebles."
            );
            ...
            toolTip.SetToolTip(
                btnAgregar,
                "Agrega el producto a los detalles del pedido."
            );
            ...
            toolTip.SetToolTip(
                btnCamcelar,
                "Cancela el registro del pedido."
            );

            // Búsqueda
            toolTip.SetToolTip(
                txtBuscar,
                "Ingrese el número o información del pedido que desea buscar."
            );

            // Tablas
            toolTip.SetToolTip(
                dgvPedidosRegistrados,
                "Aquí se muestran los pedidos registrados."
            );

            toolTip.SetToolTip(
                dgvDetallesDePedido,
                "Aquí se muestran los productos agregados al pedido."
            );
        }
        ...
        {
            frmDetallePedidoSecretario modal =
             new frmDetallePedidoSecretario();
        ...
        private void MostrarPaginaPedidos()
        {
            ...
            if (dgvPedidosRegistrados.Columns.Contains("Cliente"))
                dgvPedidosRegistrados.Columns["Cliente"].HeaderText =
                    "Cliente";
            ...
            if (dgvPedidosRegistrados.Columns.Contains("Estado"))
                dgvPedidosRegistrados.Columns["Estado"].HeaderText =
                    "Estado";
        ...
        private void MostrarDetallesPedidos()
        {
            ...
            dgvDetallesDePedido.DataSource =
                DetallePedidos.CargarDetallesPedidos();
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "Por favor ingresa las medidas del producto dando clic en 'Medidas del producto'."
                );
        ...
        {
            if (dtpFechaEntrega.Value.Date <
                dtpFechaPedido.Value.Date)
            {
                MessageBox.Show(
            ...
            {
                MessageBox.Show(
                    "Para actualizar el estado o la fecha, selecciona un pedido de la lista y presiona Guardar."
                );
            ...
            if (estadoCambio)
            {
                if (DbPedidos.ActualizarPedidoEstado(
                    idPedidoSeleccionado,
                    nuevoEstado))
                {
                    MessageBox.Show(
                        "El estado del pedido se modificó correctamente a: "
                        + nuevoEstado,
                        "Estado actualizado",
                        MessageBoxButtons.OK,
                        MessageBoxIcon.Information
        ...
        {
            ((DataTable)dgvDetallesDePedido.DataSource)?
               .RejectChanges();
        ...
        {
            if (dgvDetallesDePedido.Columns.Contains(
                "IdDetallePedido"))
            {
                dgvDetallesDePedido.Columns[
                    "IdDetallePedido"
                ].Visible = false;
            }
