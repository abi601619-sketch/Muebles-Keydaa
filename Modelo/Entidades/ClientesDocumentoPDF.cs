...
namespace Modelo.PDF
{
    public class ClientesDocumentoPDF : IDocument
    {
        ...
        public ClientesDocumentoPDF(
            DataTable clientes,
            DateTime fechaInicio,
            DateTime fechaFin,
            int clientesTotales,
            int clientesCorporativos,
            int clientesIndividuales)
        {
                            ...
                            .Row(row =>
                            {
                                ...
                                row.RelativeItem()
                                    .Column(col =>
                                    {
                                        ...
                                        {
                                            throw new Exception(
                                                "ERR-PDF-001: No se ha configurado el logo de la empresa."
                                            );
                                        }
                                        ...
                                        {
                                            throw new Exception(
                                                "ERR-PDF-002: No se encontró el logo configurado en:\n\n" +
                                                rutaLogo
                                            );
                                        }
                        ...
                        contenido.Item()
                            .Row(row =>
                            {
                                CrearTarjeta(
                                    row,
                                    "CLIENTES TOTALES",
                                    clientesTotales.ToString()
                                );

                                CrearTarjeta(
                                    row,
                                    "CLIENTES CORPORATIVOS",
                                    clientesCorporativos.ToString()
                                );

                                CrearTarjeta(
                                    row,
                                    "CLIENTES INDIVIDUALES",
                                    clientesIndividuales.ToString()
                                );
                            });
